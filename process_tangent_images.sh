...
convert dataset.png nearest_neighbors.png pca_observations.png ts_mle_iter*.png pruned_nearest_neighbors.png coord_bp.png -set delay '%[fx:t==(n-1) || t==(n-2) || t==(n-3) || t==0 || t==1 || t==2 ? 400 : 0]' result.gif
