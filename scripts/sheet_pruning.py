...
# Ideal embedding
fig, ax = plt.subplots(figsize=(14.4, 10.8), dpi=100)
arr1 = np.squeeze(np.array(true_parameters[:,0]))
arr2 = np.squeeze(np.array(true_parameters[:,1]))
ax.scatter(arr2, arr1, c=color, cmap=plt.cm.Spectral, s=embedding_sp_rad**2, linewidths=embedding_sp_lw)
